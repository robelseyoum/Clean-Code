...
import com.robelseyoum3.cleancode.util.printLogD
import kotlinx.android.parcel.IgnoredOnParcel
import java.lang.IndexOutOfBoundsException

const val MESSAGE_STACK_BUNDLE_KEY = "com.robelseyoum3.cleancode.business.domain.state.MessageStack"
    ...
    override fun removeAt(index: Int): StateMessage {
        try{
            ...
            if(this.size > 0){
                ...
                printLogD("com.robelseyoum3.cleancode.business.domain.state.MessageStack", "stack is empty: ")
